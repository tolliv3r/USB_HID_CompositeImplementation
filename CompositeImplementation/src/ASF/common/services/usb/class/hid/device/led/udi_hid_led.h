 ...
 * udi_hid_led.h
 *
 * Created: 6/9/2025 1:49:50 PM
 *  Author: jackson.clary
 */ 


#ifndef UDI_HID_LED_H_
#define UDI_HID_LED_H_
...
#  define UDI_HID_LED_STRING_ID 0
#endif


#define UDI_HID_LED_DESC {\
   ...
   .iface.iInterface          = UDI_HID_LED_STRING_ID,\
   ...
   .ep_out.wMaxPacketSize     = LE16(UDI_HID_LED_EP_SIZE),\
   .ep_out.bInterval          = 4,\
}
